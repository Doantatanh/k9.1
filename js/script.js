(function ($) {
  ...
  if ($(".main-header li.dropdown ul").length === 0) {
  ...
  //   //Dropdown Button
  //   if ($(".mobile-menu li.dropdown .dropdown-btn").length === 0) {
  ...
  // Toggle dropdown trong mobile menu
  $(document).on("click", ".dropdown-btn", function () {
    $(this).toggleClass("active"); // đổi icon + màu

    $(this).prev("ul").slideToggle(300); // mở / đóng ul
  });
