document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.confirm-total-all').forEach(el => el.innerText = formatVND(total));
    document.querySelectorAll('.confirm-bank-memo-all').forEach(el => el.innerText = orderId);
