async function loadJobs() {
  try {
    const res = await fetch("../JSON/jobs.json"); // Đường dẫn tùy thư mục bạn đặt
    const data = await res.json();

    const container = document.getElementById("jobs-list");

    if (!container) {
      console.error("Không tìm thấy #jobs-list trong HTML");
      return;
    }
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <div class="hover-effect">
                                    ...
                                    <a href="job-detail.html?slug=${job.slug}" class="link"></a>
                                </div>
                            </div>
    ...
    console.error("Lỗi load danh sách tuyển dụng:", error);
  }
}
