async function loadNewsList() {
  try {
    const res = await fetch("../JSON/tin-tuc.json");
    const data = await res.json();

    const container = document.getElementById("news-list");

    if (!container) {
      console.error("Không tìm thấy #news-list trong HTML");
      return;
    }
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <div class="hover-effect">
                                    ...
                                    <a href="article.html?slug=${article.slug}" class="link"></a>
                                </div>
                            </div>
    ...
    console.error("Lỗi load danh sách tin tức:", error);
  }
}
